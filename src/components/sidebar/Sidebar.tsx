...
import { Trash2, Plus, Download, Upload, Table2 } from 'lucide-react'
    ...
    <>
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 px-3 py-2 bg-white dark:bg-dark-panel hover:bg-red-50 dark:hover:bg-red-950/30 border border-pastel-border dark:border-dark-border text-pastel-text dark:text-dark-text hover:text-red-600 dark:hover:text-red-400 text-xs rounded-lg transition-all disabled:opacity-40 disabled:cursor-not-allowed"
              >
      ...
      {showClearConfirm && (
        <ConfirmModal
          ...
          message="Tem certeza que deseja apagar todas as tabelas e relacionamentos deste workspace?"
      ...
      {wsToDelete && (
        <ConfirmModal
          ...
          message="Tem certeza que deseja remover este workspace permanentemente?"
